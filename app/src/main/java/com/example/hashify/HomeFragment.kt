...
import com.example.hashify.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment() {
    ...
    override fun onResume() {
        ...
        val arrayAdapter =
            ArrayAdapter(requireContext(), R.layout.drop_down_list_item, hashAlgorithms)
    ...
    private suspend fun applyAnimations() {
        ...
        binding.textInputLaytout.animate()
            .alpha(0f)
